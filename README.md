...
The feature vectors X_train and X_test contain  561 calculated features from the experiment as follows:
...
## add column to define group  "train" or "test" to both train test for y
...
## Calculation applied to the feature columns

The output is a summarisation of the features grouped by subject and activity type. The summarisation was the MEAN of the features.  
 
## Mapping of original feature names to cleaned up subset
